...
('business_hours_start', '09:00', 'string', 'Clinic opening time - must match CLINIC_OPEN_TIME in server/src/utils/appointmentRules.js', true),
('business_hours_end', '18:30', 'string', 'Clinic closing time - must match CLINIC_CLOSE_TIME in server/src/utils/appointmentRules.js', true),
('lunch_break_start', '13:00', 'string', 'Lunch break start time (informational only - not enforced by booking, see appointmentRules.js)', true),
('lunch_break_end', '14:00', 'string', 'Lunch break end time (informational only - not enforced by booking, see appointmentRules.js)', true),
